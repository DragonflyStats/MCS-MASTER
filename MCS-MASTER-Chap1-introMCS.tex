...
zero. This hypothesis is accepted if the confidence interval for the estimate contains the value $0$ in its range. 
...
This hypothesis is accepted if the confidence interval for the estimate
