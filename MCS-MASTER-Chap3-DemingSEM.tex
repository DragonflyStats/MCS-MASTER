...
A formal test, proposed by \citet{BA83} on the Pearson correlation coefficient of case-wise differences and means ($\rho_{AD}$). According to \citet{BA86}, this test is equivalent to a well established tests for equality of variances, known as the `Pitman-Morgan Test' \citep{Pitman,
	Morgan}.
