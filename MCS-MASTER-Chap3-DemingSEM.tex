...
that methodology. It is upon the practitioner opinion to judge the outcome of the approach. An approach proposed by \citet{BA83} is a formal test on the
...
The classical Pitman-Morgan test can be adapted for the correlation value $\rho_{(a,d)}$, and is evaluated as follows;
...
Authors, such as a \citet{lewis}, \citet{dunnSEME} and \citet{voelkel2005}, strongly advocate the use of structural equation models for the purposes of method comparison. Conversely \citet{BA99} also states that consider structural equation models to be inappropriate.
...
\subsection{Computational Aspects of Deming Regression}
