...
function buttonClick(isvertical, event, menuId) {
  ...
  if (button != activeButton) {
    depressButton(isvertical,button);
    activeButton = button;
  }
  else
    activeButton = null;
...
function buttonMouseover(isvertical, event, menuId) {
  ...
  if (activeButton == null) {
    buttonClick(isvertical, event, menuId);
    return;
  }
...
function depressButton(isvertical, button) {
