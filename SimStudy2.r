...
betweenA=c(betweenA,var(apply(Blood2[,1:3],1,mean)))
withinA=c(withinA,var(apply(Blood2[,1:3],1,sd)))


betweenB=c(betweenB,var(apply(Blood2[,4:6],1,mean)))
withinB=c(withinB,var(apply(Blood2[,4:6],1,sd)))

betweenC=c(betweenC,var(apply(Blood2[,7:9],1,mean)))
withinC=c(withinC,var(apply(Blood2[,7:9],1,sd)))

betweenD=c(betweenD,var(apply(Blood3[,1:3],1,mean)))
withinD=c(withinD,var(apply(Blood3[,1:3],1,sd)))


betweenE=c(betweenE,var(apply(Blood3[,4:6],1,mean)))
withinE=c(withinE,var(apply(Blood3[,4:6],1,sd)))

betweenF=c(betweenF,var(apply(Blood3[,7:9],1,mean)))
withinF=c(withinF,var(apply(Blood3[,7:9],1,sd)))
##################################################################################
#End of Master Loop
...
####################
Results2 = round(data.frame(seed=1:M,withinA,withinB,withinC,withinD,withinE,withinE,betweenA,betweenB,betweenC, betweenD,betweenE,betweenF),2)



varW1= withinA/withinB

varW2= withinA/withinC

varW3= withinA/withinD

varW4= withinA/withinE

varW5= withinA/withinF


varB1= betweenA/betweenB
varB2= betweenA/betweenC


varB3= betweenA/betweenD

varB4= betweenA/betweenE
varB5= betweenA/betweenF

Results2 = round(data.frame(seed=1:M,varW1,varW2,varW3,varW4,varW5,varB1,varB2,varB3,varB4,varB5),2)
